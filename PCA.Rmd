...
Method 2 uses the result of the method 1 but applies the following transformation.
...
The aproach starts by considering the eigenvalue decomposition (also called spectral decomposition) of a correlation matrix $\mathbf{A}$ thats is given by
